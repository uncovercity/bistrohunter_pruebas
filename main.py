...
from bistrohunter import obtener_restaurantes_por_ciudad, obtener_dia_semana  # Llama a las funciones necesarias
import logging
...
@app.get("/api/getRestaurantsPrueba")  # Dentro de nuestra propia API podemos llamar a diferentes funciones. Aquí llama a obtener_restaurantes_por_ciudad
async def get_restaurantes(
    ...
    dish: Optional[str] = Query(None, description="Plato específico por el que puede preguntar un cliente"),
    ...
    try:
        ...
        # Llama a la función para obtener los restaurantes y la fórmula de filtro
...
async def procesar_variables(request: Request):
    try:
        ...
        # Llama a la función para obtener los restaurantes
